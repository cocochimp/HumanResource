        ...
        <el-form-item label="用户名" prop="username">
         ...
         <el-form-item label="密码" prop="password">
          ...
          <el-form-item label="角色选择">
             <el-select style="width:150px" v-model="selectedRoleId" placeholder="请选择">
                        <el-option
         ...
         <el-form-item class="btns">
           <el-button type="warning" @click="register" class="register">点击免费注册</el-button>
         </el-form-item>
     </el-form>  
      </div> 
  </div>
 ...
 methods:{
     ...
     register(){
       ...
       this.$refs.loginFormRef.validate(async valid=>{
          ...
          const {data:res}= await this.$http.post(`/Sys/register/${this.loginForm.username}/${this.loginForm.password}/${this.selectedRoleId}`);
