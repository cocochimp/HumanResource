 ...
 <el-card >
     <!-- 搜索与添加区域 -->
        <el-row :gutter="20">
            ...
            <el-col :span="4">
                <el-button type="primary" @click="goAddpage">添加档案</el-button>
            </el-col>
        </el-row>
        ...
        <el-table :data="userlist" border stripe>
            ...
            <el-table-column label="一级机构" prop="o1_name"></el-table-column>
            <el-table-column label="二级机构" prop="o2_name"></el-table-column>
            <el-table-column label="三级机构" prop="o3_name"></el-table-column>
            ...
            <el-table-column label="操作"  width="200px">
                <template slot-scope="scope">
                        <!-- 修改按钮 -->
                        <!-- <el-button type="primary" icon="el-icon-edit" size="mini" @click="showEditDialog(scope.row.u_id)"></el-button> -->
                        <!-- 删除按钮 -->
                        <el-button type="danger" icon="el-icon-delete"  size="mini" @click="removeUserById(scope.row.u_id)"></el-button>
                        <!-- 分配角色按钮 -->
...
export default {
 ...
 methods:{
   ...
   async getUserList(){
      ...
      const {data:res} = await this.$http.post(`/File/add/showFileApplication/${this.queryInfo.pagenum}/${this.queryInfo.pagesize}`)
