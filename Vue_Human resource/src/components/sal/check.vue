...
<el-form-item label="交通补助">
         ...
         <span slot="footer" class="dialog-footer">
                ...
                <el-button type="primary"  @click="editUserInfo1">通 过</el-button>
            </span>
...
this.getUserList()
 ...
 async editUserInfo1(){
   ...
   async getUserList(){
      ...
      const {data:res} = await this.$http.post(`/Sal/check/showSalRechecked/${this.queryInfo.pagenum}/${this.queryInfo.pagesize}`)
    //   if(res.meta.status!==200){
