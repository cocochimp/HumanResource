 ...
 <el-card >
     <!-- 搜索与添加区域 -->
        ...
        <el-table :data="userlist" border stripe>
            ...
            <el-table-column label="姓名" prop="profession"></el-table-column>
            ...
            <el-table-column label="操作">
                <template slot-scope="scope">
                        <!-- 修改按钮 -->
                        <el-button type="primary" icon="el-icon-edit" size="mini" @click="showEditDialog(scope.row.p_id)"></el-button>
                        <!-- 删除按钮 -->
...
export default {
 ...
 methods:{
   ...
   async getUserList(){
    //    this.queryInfo.pagenum=0
      const {data:res} = await this.$http.post(`/Sal/give/giveSalInfoByO3Id/${this.queryInfo.pagenum}/${this.queryInfo.pagesize}/${window.sessionStorage.getItem('id')}`)
 ...
 handleSizeChanged(newSize){
     ...
     this.queryInfo.pagesize=newSize*this.queryInfo.pagesize
     this.getUserList()
 },
 //监听页码值改变的事件
